...
<div id="v-options">
	<div id="vop-header">
		<h1><?php echo $this->themename; ?> <?php _e( 'Options', 'traction' ); ?> <img style="float: right" src="<?php echo get_bloginfo( 'stylesheet_directory' ).'/functions/pro.png' ?>" alt="PRO"/></h1>
		<p><strong><?php _e( 'Need help?', 'traction' ); ?></strong> <a href="http://thethemefoundry.com/tutorials/traction/"><?php _e( 'Read the tutorials' , 'traction' ); ?></a> <?php _e( 'or visit the <a href="http://thethemefoundry.com/forums/">support forums.</a>', 'traction' ); ?></p>
	</div><!--end vop-header-->
	<div id="vop-body">
		<form method="post">
<?php
